...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    Container:  hcv-quasi/devider:0.0.1  (built from containers/devider/Dockerfile)
...
process DEVIDER {
    ...
    // Custom image — no public registry; built locally from containers/devider/Dockerfile.
    // Image name matches the build.sh tag: hcv-quasi/devider:0.0.1
    // For conda fallback, use bin/install_devider.sh to install from source.
    container 'hcv-quasi/devider:0.0.1'
    conda     null  // no conda package; use bin/install_devider.sh for source install
